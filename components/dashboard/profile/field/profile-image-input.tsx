...
type ProfileImageInputProps<TFieldValues extends FieldValues> = {
...
const ProfileImageInput = <TFieldValues extends FieldValues>({
  form,
  name,
  pending,
  oldPreview,
}: ProfileImageInputProps<TFieldValues>) => {
  ...
  return (
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          <FormLabel className="dark:text-white">Profile Image</FormLabel>
